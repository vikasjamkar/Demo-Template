...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Get all title items
  const titleItems = document.querySelectorAll('.tab-nav-title');

  // Add click event listeners to each title item
  titleItems.forEach(item => {
    item.addEventListener('click', function () {
      // Remove active class from all title items
      ...
      const infoSections = document.querySelectorAll('.tab-nav-info');
  ...
  // Set default active tab and info
  document.querySelector('.tab-nav-title').classList.add('active');
  document.querySelector('.tab-nav-info').classList.add('active');
